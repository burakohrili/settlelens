export const turkeyRules = {
  ...
  alimonyType: "Yoksulluk nafakası (TMK 175)",
  childSupportType: "İştirak nafakası (TMK 182)",
  notes: "Net artık değer = Edinilmiş mal - Kişisel mal. Her eş diğerinin net artık değerinin yarısını talep edebilir.",
};
